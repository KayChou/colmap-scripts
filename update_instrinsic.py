...
def camTodatabase(database, txtfile):
    import os
    import argparse
...
if __name__ == "__main__":
    created_dir = "/home/benjamin/Workspace/calibration_opencv/mvs_calibration/created/"
    camTodatabase(f"{created_dir}cameras.txt")